...
CONSTRAINT `auth_group_permissi_permission_id_23962d04_fk_auth_permission_id` FOREIGN KEY (`permission_id`
...
CONSTRAINT `auth_permissi_content_type_id_51277a81_fk_django_content_type_id` FOREIGN KEY (`content_type_id`
...
CONSTRAINT `auth_user_user_perm_permission_id_3d7071f0_fk_auth_permission_id` FOREIGN KEY (`permission_id`
) REFERENCES `auth_permission` (` id `
)
...
CONSTRAINT `basedata_addr_content_type_id_17983026_fk_django_content_type_id` FOREIGN KEY (`content_type_id`
) REFERENCES `django_content_type` (` id `
)
) ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
CONSTRAINT `basedata_bankaccount_org_id_6017321e_fk_organ_organization_id` FOREIGN KEY (`org_id`
) REFERENCES `organ_organization` (` id `
),
CONSTRAINT `basedata_bankaccount_partner_id_561018ee_fk_basedata_partner_id` FOREIGN KEY (`partner_id`
) REFERENCES `basedata_partner` (` id `
)
...
CONSTRAINT `basedata_brand_trade_id_bdcfb86_fk_basedata_trade_id` FOREIGN KEY (`trade_id`
) REFERENCES `basedata_trade` (` id `
)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET =utf8;
...
CONSTRAINT `basedata_category_parent_id_43280ad5_fk_basedata_category_id` FOREIGN KEY (`parent_id`
) REFERENCES `basedata_category` (` id `
),
CONSTRAINT `basedata_category_trade_id_7d069922_fk_basedata_trade_id` FOREIGN KEY (`trade_id`
) REFERENCES `basedata_trade` (` id `
)
...
CONSTRAINT `basedata_data_content_type_id_2051ca2a_fk_django_content_type_id` FOREIGN KEY (`content_type_id`
) REFERENCES `django_content_type` (` id `
)
...
CONSTRAINT `basedata_document_user_id_105428c7_fk_auth_user_id` FOREIGN KEY (`user_id`
) REFERENCES `auth_user` (` id `
)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET =utf8;
...
CONSTRAINT `basedata_education_employee_id_54096a10_fk_basedata_employee_id` FOREIGN KEY (`employee_id`
) REFERENCES `basedata_employee` (` id `
)
) ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
CONSTRAINT `basedata_employee_position_id_3d7368b4_fk_organ_position_id` FOREIGN KEY (`position_id`
) REFERENCES `organ_position` (` id `
),
CONSTRAINT `basedata_employee_user_id_6883fc78_fk_auth_user_id` FOREIGN KEY (`user_id`
) REFERENCES `auth_user` (` id `
),
CONSTRAINT `basedata_emplo_organization_id_3b46dfdc_fk_organ_organization_id` FOREIGN KEY (`organization_id`
) REFERENCES `organ_organization` (` id `
)
...
CONSTRAINT `basedata_expenseaccount_org_id_5661eb95_fk_organ_organization_id` FOREIGN KEY (`org_id`
) REFERENCES `organ_organization` (` id `
),
CONSTRAINT `basedata_expens_parent_id_61334aac_fk_basedata_expenseaccount_id` FOREIGN KEY (`parent_id`
) REFERENCES `basedata_expenseaccount` (` id `
)
...
CONSTRAINT `basedata_extraparam_material_id_615a14c3_fk_basedata_material_id` FOREIGN KEY (`material_id`
) REFERENCES `basedata_material` (` id `
)
...
CONSTRAINT `basedata_family_employee_id_2c56437d_fk_basedata_employee_id` FOREIGN KEY (`employee_id`
) REFERENCES `basedata_employee` (` id `
)
) ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
CONSTRAINT `basedata_material_brand_id_70cca220_fk_basedata_brand_id` FOREIGN KEY (`brand_id`
) REFERENCES `basedata_brand` (` id `
),
CONSTRAINT `basedata_material_category_id_7ca5506e_fk_basedata_category_id` FOREIGN KEY (`category_id`
) REFERENCES `basedata_category` (` id `
),
CONSTRAINT `basedata_material_org_id_1ac5ffff_fk_organ_organization_id` FOREIGN KEY (`org_id`
) REFERENCES `organ_organization` (` id `
),
CONSTRAINT `basedata_material_warehouse_id_1e7533f6_fk_basedata_warehouse_id` FOREIGN KEY (`warehouse_id`
) REFERENCES `basedata_warehouse` (` id `
)
...
CONSTRAINT `basedata_material_mea_measure_id_5c0d90fc_fk_basedata_measure_id` FOREIGN KEY (`measure_id`
) REFERENCES `basedata_measure` (` id `
),
CONSTRAINT `basedata_material_me_material_id_572f4c8_fk_basedata_material_id` FOREIGN KEY (`material_id`
) REFERENCES `basedata_material` (` id `
)
...
CONSTRAINT `basedata_materialpa_material_id_666e08d1_fk_basedata_material_id` FOREIGN KEY (`material_id`
) REFERENCES `basedata_material` (` id `
),
CONSTRAINT `bas_param_name_id_3c50302d_fk_basedata_technicalparametername_id` FOREIGN KEY (`param_name_id`
) REFERENCES `basedata_technicalparametername` (` id `
),
CONSTRAINT `b_param_value_id_18882fba_fk_basedata_technicalparametervalue_id` FOREIGN KEY (`param_value_id`
) REFERENCES `basedata_technicalparametervalue` (` id `
)
) ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
CREATE TABLE `basedata_partner` (
  ...
  `tax_address` varchar (40
) DEFAULT NULL,
  `tax_account` varchar (80
) DEFAULT NULL,
  `contacts` varchar (40
),
  `memo` longtext,
...
CONSTRAINT `basedata_partner_org_id_29c57159_fk_organ_organization_id` FOREIGN KEY (`org_id`
) REFERENCES `organ_organization` (` id `
)
...
CONSTRAINT `basedata_project_org_id_5726486_fk_organ_organization_id` FOREIGN KEY (`org_id`
) REFERENCES `organ_organization` (` id `
),
CONSTRAINT `basedata_project_partner_id_36721156_fk_basedata_partner_id` FOREIGN KEY (`partner_id`
) REFERENCES `basedata_partner` (` id `
)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET =utf8;
...
CONSTRAINT `basedata_project_users_project_id_1560ad8_fk_basedata_project_id` FOREIGN KEY (`project_id`
) REFERENCES `basedata_project` (` id `
),
CONSTRAINT `basedata_project_users_user_id_2b10e1a1_fk_auth_user_id` FOREIGN KEY (`user_id`
) REFERENCES `auth_user` (` id `
)
) ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
CONSTRAINT `basedata_technicalpa_category_id_8e419b4_fk_basedata_category_id` FOREIGN KEY (`category_id`
) REFERENCES `basedata_category` (` id `
)
) ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
CONSTRAINT `base_tech_name_id_401b4baa_fk_basedata_technicalparametername_id` FOREIGN KEY (`tech_name_id`
) REFERENCES `basedata_technicalparametername` (` id `
)
) ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
CONSTRAINT `basedata_trade_parent_id_40eb4a8a_fk_basedata_trade_id` FOREIGN KEY (`parent_id`
) REFERENCES `basedata_trade` (` id `
)
...
CONSTRAINT `basedata_valuelist_locked_by_id_3ddaefa_fk_auth_user_id` FOREIGN KEY (`locked_by_id`
) REFERENCES `auth_user` (` id `
),
CONSTRAINT `basedata_valuelist_module_id_249f4ef9_fk_syscfg_module_id` FOREIGN KEY (`module_id`
) REFERENCES `syscfg_module` (` id `
)
...
CONSTRAINT `basedata_valuelistite_group_id_435c66f8_fk_basedata_valuelist_id` FOREIGN KEY (`group_id`
) REFERENCES `basedata_valuelist` (` id `
)
...
CONSTRAINT `basedata_warehouse_org_id_1160a0d2_fk_organ_organization_id` FOREIGN KEY (`org_id`
) REFERENCES `organ_organization` (` id `
)
...
CONSTRAINT `basedata_warehouse_users_user_id_c95aacd_fk_auth_user_id` FOREIGN KEY (`user_id`
) REFERENCES `auth_user` (` id `
),
CONSTRAINT `basedata_warehous_warehouse_id_2b476168_fk_basedata_warehouse_id` FOREIGN KEY (`warehouse_id`
) REFERENCES `basedata_warehouse` (` id `
)
) ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
CONSTRAINT `basedata_workexperi_employee_id_1ccfb6d0_fk_basedata_employee_id` FOREIGN KEY (`employee_id`
) REFERENCES `basedata_employee` (` id `
)
) ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
CONSTRAINT `django_admin__content_type_id_5151027a_fk_django_content_type_id` FOREIGN KEY (`content_type_id`
) REFERENCES `django_content_type` (` id `
)
...
CONSTRAINT `hr_departure_employee_id_cd15087_fk_basedata_employee_id` FOREIGN KEY (`employee_id`
) REFERENCES `basedata_employee` (` id `
)
) ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
CREATE TABLE `hr_employeesalaryitem` (
  ...
  `calculate_way` varchar (2
) NOT NULL,
  `fixed_value` decimal (10, 2
) DEFAULT NULL,
  `base_value` decimal (10, 2
) DEFAULT NULL,
  `org_percent` decimal (4, 2
) DEFAULT NULL,
  `employee_percent` decimal (4, 2
) DEFAULT NULL,
  `employee_id` int (11
) DEFAULT NULL,
  `entry_id` int (11
) NOT NULL,
  `salary_item_id` int (11
) NOT NULL,
PRIMARY KEY (` id `
),
...
CONSTRAINT `hr_employeesalaryitem_entry_id_24d5804c_fk_hr_entry_id` FOREIGN KEY (`entry_id`
) REFERENCES `hr_entry` (` id `
),
CONSTRAINT `hr_employeesalaryite_salary_item_id_308f4922_fk_hr_salaryitem_id` FOREIGN KEY (`salary_item_id`
) REFERENCES `hr_salaryitem` (` id `
),
CONSTRAINT `hr_employeesalaryit_employee_id_3ca63cb3_fk_basedata_employee_id` FOREIGN KEY (`employee_id`
) REFERENCES `basedata_employee` (` id `
)
) ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
CONSTRAINT `hr_entry_guider_id_677409a1_fk_basedata_employee_id` FOREIGN KEY (`guider_id`
) REFERENCES `basedata_employee` (` id `
),
CONSTRAINT `hr_entry_position_id_70f8683c_fk_organ_position_id` FOREIGN KEY (`position_id`
) REFERENCES `organ_position` (` id `
)
) ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
CONSTRAINT `hr_transfer_employee_id_58f1c915_fk_basedata_employee_id` FOREIGN KEY (`employee_id`
) REFERENCES `basedata_employee` (` id `
)
) ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
CONSTRAINT `invent_adjustitem_inventory_id_26479e75_fk_invent_inventory_id` FOREIGN KEY (`inventory_id`
) REFERENCES `invent_inventory` (` id `
),
CONSTRAINT `invent_adjustitem_master_id_4e55f6a0_fk_invent_wareadjust_id` FOREIGN KEY (`master_id`
) REFERENCES `invent_wareadjust` (` id `
),
CONSTRAINT `invent_adju_inoutdetail_ptr_id_56d701c4_fk_invent_inoutdetail_id` FOREIGN KEY (`inoutdetail_ptr_id`
) REFERENCES `invent_inoutdetail` (` id `
)
) ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
CONSTRAINT `invent_initem_master_id_777093cc_fk_invent_stockin_id` FOREIGN KEY (`master_id`
) REFERENCES `invent_stockin` (` id `
),
CONSTRAINT `invent_initem_po_item_id_10308e1c_fk_purchase_poitem_id` FOREIGN KEY (`po_item_id`
) REFERENCES `purchase_poitem` (` id `
),
CONSTRAINT `invent_init_inoutdetail_ptr_id_62cb8948_fk_invent_inoutdetail_id` FOREIGN KEY (`inoutdetail_ptr_id`
) REFERENCES `invent_inoutdetail` (` id `
)
) ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
CONSTRAINT `invent_initialinventory_org_id_5505a597_fk_organ_organization_id` FOREIGN KEY (`org_id`
) REFERENCES `organ_organization` (` id `
),
CONSTRAINT `invent_initialinventory_user_id_52fe41ef_fk_auth_user_id` FOREIGN KEY (`user_id`
) REFERENCES `auth_user` (` id `
)
...
CONSTRAINT `invent_inititem_master_id_2e3b4e8d_fk_invent_initialinventory_id` FOREIGN KEY (`master_id`
) REFERENCES `invent_initialinventory` (` id `
),
CONSTRAINT `invent_init_inoutdetail_ptr_id_4be99311_fk_invent_inoutdetail_id` FOREIGN KEY (`inoutdetail_ptr_id`
) REFERENCES `invent_inoutdetail` (` id `
)
) ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
CONSTRAINT `invent_inoutdetail_material_id_61f641de_fk_basedata_material_id` FOREIGN KEY (`material_id`
) REFERENCES `basedata_material` (` id `
),
CONSTRAINT `invent_inoutdetail_measure_id_24903062_fk_basedata_measure_id` FOREIGN KEY (`measure_id`
) REFERENCES `basedata_measure` (` id `
),
CONSTRAINT `invent_inoutdetail_warehouse_id_b6de15f_fk_basedata_warehouse_id` FOREIGN KEY (`warehouse_id`
) REFERENCES `basedata_warehouse` (` id `
)
...
CONSTRAINT `invent_inventory_material_id_7b04cfa0_fk_basedata_material_id` FOREIGN KEY (`material_id`
) REFERENCES `basedata_material` (` id `
),
CONSTRAINT `invent_inventory_measure_id_66c34c34_fk_basedata_measure_id` FOREIGN KEY (`measure_id`
) REFERENCES `basedata_measure` (` id `
),
CONSTRAINT `invent_inventory_org_id_3e72901a_fk_organ_organization_id` FOREIGN KEY (`org_id`
) REFERENCES `organ_organization` (` id `
),
CONSTRAINT `invent_inventory_warehouse_id_7b12f523_fk_basedata_warehouse_id` FOREIGN KEY (`warehouse_id`
) REFERENCES `basedata_warehouse` (` id `
)
) ENGINE=InnoDB AUTO_INCREMENT=55 DEFAULT CHARSET =utf8;
...
CONSTRAINT `invent_outitem_inventory_id_1a5f5da3_fk_invent_inventory_id` FOREIGN KEY (`inventory_id`
) REFERENCES `invent_inventory` (` id `
),
CONSTRAINT `invent_outitem_master_id_5d572ab8_fk_invent_stockout_id` FOREIGN KEY (`master_id`
) REFERENCES `invent_stockout` (` id `
),
CONSTRAINT `invent_outi_inoutdetail_ptr_id_60f3e3dc_fk_invent_inoutdetail_id` FOREIGN KEY (`inoutdetail_ptr_id`
) REFERENCES `invent_inoutdetail` (` id `
)
) ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
CONSTRAINT `invent_out_item_id_735b9d2f_fk_invent_outitem_inoutdetail_ptr_id` FOREIGN KEY (`out_item_id`
) REFERENCES `invent_outitem` (`inoutdetail_ptr_id`
),
CONSTRAINT `invent_returnitem_master_id_11698bd3_fk_invent_warereturn_id` FOREIGN KEY (`master_id`
) REFERENCES `invent_warereturn` (` id `
),
CONSTRAINT `invent_retu_inoutdetail_ptr_id_616dfca9_fk_invent_inoutdetail_id` FOREIGN KEY (`inoutdetail_ptr_id`
) REFERENCES `invent_inoutdetail` (` id `
)
) ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
CONSTRAINT `invent_stockin_org_id_138faa53_fk_organ_organization_id` FOREIGN KEY (`org_id`
) REFERENCES `organ_organization` (` id `
),
CONSTRAINT `invent_stockin_po_id_54608973_fk_purchase_purchaseorder_id` FOREIGN KEY (`po_id`
) REFERENCES `purchase_purchaseorder` (` id `
),
CONSTRAINT `invent_stockin_user_id_7ca6d2b_fk_auth_user_id` FOREIGN KEY (`user_id`
) REFERENCES `auth_user` (` id `
),
CONSTRAINT `invent_stockin_warehouse_id_77701ff6_fk_basedata_warehouse_id` FOREIGN KEY (`warehouse_id`
) REFERENCES `basedata_warehouse` (` id `
)
...
CONSTRAINT `invent_stockout_org_id_71a748a3_fk_organ_organization_id` FOREIGN KEY (`org_id`
) REFERENCES `organ_organization` (` id `
),
CONSTRAINT `invent_stockout_project_id_4e2d4cbc_fk_basedata_project_id` FOREIGN KEY (`project_id`
) REFERENCES `basedata_project` (` id `
),
CONSTRAINT `invent_stockout_user_id_537784b_fk_auth_user_id` FOREIGN KEY (`user_id`
) REFERENCES `auth_user` (` id `
),
CONSTRAINT `invent_stockout_wo_id_3c16dd70_fk_selfhelp_workorder_id` FOREIGN KEY (`wo_id`
) REFERENCES `selfhelp_workorder` (` id `
)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET =utf8;
...
CONSTRAINT `invent_wareadjust_org_id_4dd80263_fk_organ_organization_id` FOREIGN KEY (`org_id`
) REFERENCES `organ_organization` (` id `
),
CONSTRAINT `invent_wareadjust_user_id_5f3e6fc5_fk_auth_user_id` FOREIGN KEY (`user_id`
) REFERENCES `auth_user` (` id `
)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET =utf8;
...
CONSTRAINT `invent_warereturn_org_id_c9a93c_fk_organ_organization_id` FOREIGN KEY (`org_id`
) REFERENCES `organ_organization` (` id `
),
CONSTRAINT `invent_warereturn_out_id_3a81433a_fk_invent_stockout_id` FOREIGN KEY (`out_id`
) REFERENCES `invent_stockout` (` id `
),
CONSTRAINT `invent_warereturn_user_id_5a6b8d9c_fk_auth_user_id` FOREIGN KEY (`user_id`
) REFERENCES `auth_user` (` id `
)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET =utf8;
...
CONSTRAINT `organ_orgunit_organization_id_56741454_fk_organ_organization_id` FOREIGN KEY (`organization_id`
) REFERENCES `organ_organization` (` id `
),
CONSTRAINT `organ_orgunit_parent_id_20b497af_fk_organ_orgunit_id` FOREIGN KEY (`parent_id`
) REFERENCES `organ_orgunit` (` id `
)
...
CONSTRAINT `organ_position_organization_id_3435c72a_fk_organ_organization_id` FOREIGN KEY (`organization_id`
) REFERENCES `organ_organization` (` id `
),
CONSTRAINT `organ_position_parent_id_1d9e732d_fk_organ_position_id` FOREIGN KEY (`parent_id`
) REFERENCES `organ_position` (` id `
),
CONSTRAINT `organ_position_unit_id_411e3ee9_fk_organ_orgunit_id` FOREIGN KEY (`unit_id`
) REFERENCES `organ_orgunit` (` id `
)
...
CREATE TABLE `purchase_invoice` (
  ...
  `po_amount` decimal (14, 4
) DEFAULT NULL,
  `vo_amount` decimal (14, 4
) NOT NULL,
  ` file ` varchar (100
) DEFAULT NULL,
  `partner_id` int (11
...
CONSTRAINT `purchase_invoice_partner_id_7ee3f712_fk_basedata_partner_id` FOREIGN KEY (`partner_id`
) REFERENCES `basedata_partner` (` id `
),
CONSTRAINT `purchase_invoice_po_id_3777f562_fk_purchase_purchaseorder_id` FOREIGN KEY (`po_id`
) REFERENCES `purchase_purchaseorder` (` id `
)
) ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
CONSTRAINT `purchase_payment_bank_id_66ac7b06_fk_basedata_bankaccount_id` FOREIGN KEY (`bank_id`
) REFERENCES `basedata_bankaccount` (` id `
),
CONSTRAINT `purchase_payment_org_id_33cf80e9_fk_organ_organization_id` FOREIGN KEY (`org_id`
) REFERENCES `organ_organization` (` id `
),
CONSTRAINT `purchase_payment_partner_id_102965e7_fk_basedata_partner_id` FOREIGN KEY (`partner_id`
) REFERENCES `basedata_partner` (` id `
),
CONSTRAINT `purchase_payment_po_id_3291acc9_fk_purchase_purchaseorder_id` FOREIGN KEY (`po_id`
) REFERENCES `purchase_purchaseorder` (` id `
)
) ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
CONSTRAINT `purchase_poitem_material_id_10910564_fk_basedata_material_id` FOREIGN KEY (`material_id`
) REFERENCES `basedata_material` (` id `
),
CONSTRAINT `purchase_poitem_measure_id_115682d0_fk_basedata_measure_id` FOREIGN KEY (`measure_id`
) REFERENCES `basedata_measure` (` id `
),
CONSTRAINT `purchase_poitem_po_id_698de2ca_fk_purchase_purchaseorder_id` FOREIGN KEY (`po_id`
) REFERENCES `purchase_purchaseorder` (` id `
),
CONSTRAINT `purchase_poitem_woitem_id_7ee62f3a_fk_selfhelp_woitem_id` FOREIGN KEY (`woitem_id`
) REFERENCES `selfhelp_woitem` (` id `
)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET =utf8;
...
CONSTRAINT `purchase_purchaseorder_org_id_5454e9a_fk_organ_organization_id` FOREIGN KEY (`org_id`
) REFERENCES `organ_organization` (` id `
),
CONSTRAINT `purchase_purchaseorder_partner_id_4f47a8a_fk_basedata_partner_id` FOREIGN KEY (`partner_id`
) REFERENCES `basedata_partner` (` id `
),
CONSTRAINT `purchase_purchaseorder_user_id_6da1490e_fk_auth_user_id` FOREIGN KEY (`user_id`
) REFERENCES `auth_user` (` id `
)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET =utf8;
...
CONSTRAINT `sale_offeritem_master_id_759ed829_fk_sale_offersheet_id` FOREIGN KEY (`master_id`
) REFERENCES `sale_offersheet` (` id `
),
CONSTRAINT `sale_offeritem_material_id_1984f90_fk_basedata_material_id` FOREIGN KEY (`material_id`
) REFERENCES `basedata_material` (` id `
),
CONSTRAINT `sale_offeritem_measure_id_3e74b43c_fk_basedata_measure_id` FOREIGN KEY (`measure_id`
) REFERENCES `basedata_measure` (` id `
)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET =utf8;
...
CONSTRAINT `sale_offersheet_org_id_4224cc19_fk_organ_organization_id` FOREIGN KEY (`org_id`
) REFERENCES `organ_organization` (` id `
),
CONSTRAINT `sale_offersheet_partner_id_180d0c89_fk_basedata_partner_id` FOREIGN KEY (`partner_id`
) REFERENCES `basedata_partner` (` id `
),
CONSTRAINT `sale_offersheet_user_id_34ea58c1_fk_auth_user_id` FOREIGN KEY (`user_id`
) REFERENCES `auth_user` (` id `
)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET =utf8;
...
CREATE TABLE `sale_paymentcollection` (
  ...
  `order_amount` decimal (14, 4
) DEFAULT NULL,
  `collection_amount` decimal (14, 4
) NOT NULL,
  `memo` longtext,
  `bank_id` int (11
) DEFAULT NULL,
...
CONSTRAINT `sale_paymentcollection_org_id_3858f3f_fk_organ_organization_id` FOREIGN KEY (`org_id`
) REFERENCES `organ_organization` (` id `
),
CONSTRAINT `sale_paymentcollection_so_id_1640456e_fk_sale_saleorder_id` FOREIGN KEY (`so_id`
) REFERENCES `sale_saleorder` (` id `
),
CONSTRAINT `sale_paymentcollectio_partner_id_545062b1_fk_basedata_partner_id` FOREIGN KEY (`partner_id`
) REFERENCES `basedata_partner` (` id `
),
CONSTRAINT `sale_paymentcollecti_bank_id_5db2135c_fk_basedata_bankaccount_id` FOREIGN KEY (`bank_id`
) REFERENCES `basedata_bankaccount` (` id `
)
) ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
CONSTRAINT `sale_saleitem_master_id_7aa6dde1_fk_sale_saleorder_id` FOREIGN KEY (`master_id`
) REFERENCES `sale_saleorder` (` id `
),
CONSTRAINT `sale_saleitem_material_id_4cb3eb8_fk_basedata_material_id` FOREIGN KEY (`material_id`
) REFERENCES `basedata_material` (` id `
),
CONSTRAINT `sale_saleitem_measure_id_317dc10c_fk_basedata_measure_id` FOREIGN KEY (`measure_id`
) REFERENCES `basedata_measure` (` id `
)
) ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
CONSTRAINT `sale_saleorder_org_id_1d0df2d2_fk_organ_organization_id` FOREIGN KEY (`org_id`
) REFERENCES `organ_organization` (` id `
),
CONSTRAINT `sale_saleorder_partner_id_31af6b7e_fk_basedata_partner_id` FOREIGN KEY (`partner_id`
) REFERENCES `basedata_partner` (` id `
),
CONSTRAINT `sale_saleorder_user_id_1b41e486_fk_auth_user_id` FOREIGN KEY (`user_id`
) REFERENCES `auth_user` (` id `
)
) ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
CREATE TABLE `selfhelp_activity` (
  ...
  `mail_list` longtext,
  `mail_notice` tinyint (1
) NOT NULL,
  `short_message_notice` tinyint (1
) NOT NULL,
  `weixin_notice` tinyint (1
) NOT NULL,
  `status` tinyint (1
) NOT NULL,
...
CONSTRAINT `selfhelp_activity_parent_id_1638e788_fk_selfhelp_activity_id` FOREIGN KEY (`parent_id`
) REFERENCES `selfhelp_activity` (` id `
),
CONSTRAINT `selfhelp_activity_room_id_76f73121_fk_basedata_material_id` FOREIGN KEY (`room_id`
) REFERENCES `basedata_material` (` id `
)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET =utf8;
...
CONSTRAINT `selfhelp_enroll_activity_id_5615acbc_fk_selfhelp_activity_id` FOREIGN KEY (`activity_id`
) REFERENCES `selfhelp_activity` (` id `
),
CONSTRAINT `selfhelp_enroll_user_id_a71585e_fk_auth_user_id` FOREIGN KEY (`user_id`
) REFERENCES `auth_user` (` id `
)
) ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
CONSTRAINT `selfhelp_feedback_activity_id_1591e8eb_fk_selfhelp_activity_id` FOREIGN KEY (`activity_id`
) REFERENCES `selfhelp_activity` (` id `
),
CONSTRAINT `selfhelp_feedback_user_id_10b5739_fk_auth_user_id` FOREIGN KEY (`user_id`
) REFERENCES `auth_user` (` id `
)
) ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
CONSTRAINT `selfhelp_loan_project_id_7b541607_fk_basedata_project_id` FOREIGN KEY (`project_id`
) REFERENCES `basedata_project` (` id `
),
CONSTRAINT `selfhelp_loan_user_id_1d36464e_fk_auth_user_id` FOREIGN KEY (`user_id`
) REFERENCES `auth_user` (` id `
)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET =utf8;
...
CONSTRAINT `selfhelp_reimbursement_loan_id_44fd1f10_fk_selfhelp_loan_id` FOREIGN KEY (`loan_id`
) REFERENCES `selfhelp_loan` (` id `
),
CONSTRAINT `selfhelp_reimbursement_org_id_1e6a35f_fk_organ_orgunit_id` FOREIGN KEY (`org_id`
) REFERENCES `organ_orgunit` (` id `
),
CONSTRAINT `selfhelp_reimbursement_project_id_ed3db4e_fk_basedata_project_id` FOREIGN KEY (`project_id`
) REFERENCES `basedata_project` (` id `
),
CONSTRAINT `selfhelp_reimbursement_user_id_5d122f07_fk_auth_user_id` FOREIGN KEY (`user_id`
) REFERENCES `auth_user` (` id `
),
CONSTRAINT `selfhelp_reimbursement_wo_id_ac8ed7a_fk_selfhelp_workorder_id` FOREIGN KEY (`wo_id`
) REFERENCES `selfhelp_workorder` (` id `
)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET =utf8;
...
CONSTRAINT `selfhelp__reimbursement_id_37efbf0e_fk_selfhelp_reimbursement_id` FOREIGN KEY (`reimbursement_id`
) REFERENCES `selfhelp_reimbursement` (` id `
),
CONSTRAINT `selfhe_expense_account_id_65c44030_fk_basedata_expenseaccount_id` FOREIGN KEY (`expense_account_id`
) REFERENCES `basedata_expenseaccount` (` id `
)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET =utf8;
...
CONSTRAINT `selfhelp_woextrav_workorder_id_781e29d2_fk_selfhelp_workorder_id` FOREIGN KEY (`workorder_id`
) REFERENCES `selfhelp_workorder` (` id `
),
CONSTRAINT `selfhelp_woextr_param_name_id_34779449_fk_basedata_extraparam_id` FOREIGN KEY (`param_name_id`
) REFERENCES `basedata_extraparam` (` id `
)
...
CONSTRAINT `selfhelp_woitem_material_id_34e897bf_fk_basedata_material_id` FOREIGN KEY (`material_id`
) REFERENCES `basedata_material` (` id `
),
CONSTRAINT `selfhelp_woitem_measure_id_2352ebad_fk_basedata_measure_id` FOREIGN KEY (`measure_id`
) REFERENCES `basedata_measure` (` id `
),
CONSTRAINT `selfhelp_woitem_workorder_id_6a435420_fk_selfhelp_workorder_id` FOREIGN KEY (`workorder_id`
) REFERENCES `selfhelp_workorder` (` id `
)
) ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
CONSTRAINT `selfhelp_workorder_project_id_66ab927f_fk_basedata_project_id` FOREIGN KEY (`project_id`
) REFERENCES `basedata_project` (` id `
),
CONSTRAINT `selfhelp_workorder_refer_id_212bc854_fk_selfhelp_workorder_id` FOREIGN KEY (`refer_id`
) REFERENCES `selfhelp_workorder` (` id `
),
CONSTRAINT `selfhelp_workorder_service_id_17a66979_fk_basedata_material_id` FOREIGN KEY (`service_id`
) REFERENCES `basedata_material` (` id `
),
CONSTRAINT `selfhelp_workorder_user_id_72d939fa_fk_auth_user_id` FOREIGN KEY (`user_id`
) REFERENCES `auth_user` (` id `
)
...
CONSTRAINT `syscfg_menu_module_id_14fa2e70_fk_syscfg_module_id` FOREIGN KEY (`module_id`
) REFERENCES `syscfg_module` (` id `
)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET =utf8;
...
CONSTRAINT `syscfg_module_parent_id_350dc54d_fk_syscfg_module_id` FOREIGN KEY (`parent_id`
) REFERENCES `syscfg_module` (` id `
)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET =utf8;
...
CONSTRAINT `syscfg_role_parent_id_161850bd_fk_syscfg_role_id` FOREIGN KEY (`parent_id`
) REFERENCES `syscfg_role` (` id `
)
...
CONSTRAINT `syscfg_role_menus_menu_id_4fb81053_fk_syscfg_menu_id` FOREIGN KEY (`menu_id`
) REFERENCES `syscfg_menu` (` id `
),
CONSTRAINT `syscfg_role_menus_role_id_2c83ed04_fk_syscfg_role_id` FOREIGN KEY (`role_id`
) REFERENCES `syscfg_role` (` id `
)
) ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
CONSTRAINT `syscfg_role_users_role_id_50b58548_fk_syscfg_role_id` FOREIGN KEY (`role_id`
) REFERENCES `syscfg_role` (` id `
),
CONSTRAINT `syscfg_role_users_user_id_3ede60c3_fk_auth_user_id` FOREIGN KEY (`user_id`
) REFERENCES `auth_user` (` id `
)
) ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
CONSTRAINT `syscfg_site_user_site_id_e6ec06c_fk_syscfg_site_id` FOREIGN KEY (`site_id`
) REFERENCES `syscfg_site` (` id `
),
CONSTRAINT `syscfg_site_user_user_id_31f8aecc_fk_auth_user_id` FOREIGN KEY (`user_id`
) REFERENCES `auth_user` (` id `
)
) ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
CONSTRAINT `workflow_history_inst_id_2237d3b0_fk_workflow_instance_id` FOREIGN KEY (`inst_id`
) REFERENCES `workflow_instance` (` id `
),
CONSTRAINT `workflow_history_node_id_54527354_fk_workflow_node_id` FOREIGN KEY (`node_id`
) REFERENCES `workflow_node` (` id `
),
CONSTRAINT `workflow_history_user_id_4dee98c5_fk_auth_user_id` FOREIGN KEY (`user_id`
) REFERENCES `auth_user` (` id `
)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET =utf8;
...
CONSTRAINT `workflow_instance_modal_id_3eb1d1ea_fk_workflow_modal_id` FOREIGN KEY (`modal_id`
) REFERENCES `workflow_modal` (` id `
),
CONSTRAINT `workflow_instance_starter_id_3e0b14b6_fk_auth_user_id` FOREIGN KEY (`starter_id`
) REFERENCES `auth_user` (` id `
)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET =utf8;
...
CONSTRAINT `workflow_instance_current_n_node_id_54bc8d3a_fk_workflow_node_id` FOREIGN KEY (`node_id`
) REFERENCES `workflow_node` (` id `
),
CONSTRAINT `workflow_instance_cu_instance_id_556870f_fk_workflow_instance_id` FOREIGN KEY (`instance_id`
) REFERENCES `workflow_instance` (` id `
)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET =utf8;
...
CONSTRAINT `workflow_moda_content_type_id_7646d9af_fk_django_content_type_id` FOREIGN KEY (`content_type_id`
) REFERENCES `django_content_type` (` id `
)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET =utf8;
...
CREATE TABLE `workflow_node` (
  ...
  `can_terminate` tinyint (1
) NOT NULL,
  `can_deny` tinyint (1
) NOT NULL,
  `email_notice` tinyint (1
) NOT NULL,
  `short_message_notice` tinyint (1
) NOT NULL,
  `approve_node` tinyint (1
) NOT NULL,
  `handler` longtext,
  `handler_type` int (11
) NOT NULL,
...
CONSTRAINT `workflow_node_modal_id_3aa9d381_fk_workflow_modal_id` FOREIGN KEY (`modal_id`
) REFERENCES `workflow_modal` (` id `
)
...
CONSTRAINT `workflow_node_departments_node_id_379e5725_fk_workflow_node_id` FOREIGN KEY (`node_id`
) REFERENCES `workflow_node` (` id `
),
CONSTRAINT `workflow_node_department_orgunit_id_276f2bb6_fk_organ_orgunit_id` FOREIGN KEY (`orgunit_id`
) REFERENCES `organ_orgunit` (` id `
)
) ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
CONSTRAINT `workflow_node_next_from_node_id_78e6ce74_fk_workflow_node_id` FOREIGN KEY (`from_node_id`
) REFERENCES `workflow_node` (` id `
),
CONSTRAINT `workflow_node_next_to_node_id_71e709f3_fk_workflow_node_id` FOREIGN KEY (`to_node_id`
) REFERENCES `workflow_node` (` id `
)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET =utf8;
...
CONSTRAINT `workflow_node_positions_node_id_64f898c6_fk_workflow_node_id` FOREIGN KEY (`node_id`
) REFERENCES `workflow_node` (` id `
),
CONSTRAINT `workflow_node_position_position_id_187bce75_fk_organ_position_id` FOREIGN KEY (`position_id`
) REFERENCES `organ_position` (` id `
)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET =utf8;
...
CONSTRAINT `workflow_node_roles_node_id_c6ea3f5_fk_workflow_node_id` FOREIGN KEY (`node_id`
) REFERENCES `workflow_node` (` id `
),
CONSTRAINT `workflow_node_roles_role_id_1b05e9ff_fk_syscfg_role_id` FOREIGN KEY (`role_id`
) REFERENCES `syscfg_role` (` id `
)
) ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
CONSTRAINT `workflow_node_users_node_id_4b2940ca_fk_workflow_node_id` FOREIGN KEY (`node_id`
) REFERENCES `workflow_node` (` id `
),
CONSTRAINT `workflow_node_users_user_id_36b0d3c5_fk_auth_user_id` FOREIGN KEY (`user_id`
) REFERENCES `auth_user` (` id `
)
) ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
CONSTRAINT `workflow_todolist_inst_id_5f7d95_fk_workflow_instance_id` FOREIGN KEY (`inst_id`
) REFERENCES `workflow_instance` (` id `
),
CONSTRAINT `workflow_todolist_node_id_6be79401_fk_workflow_node_id` FOREIGN KEY (`node_id`
) REFERENCES `workflow_node` (` id `
),
CONSTRAINT `workflow_todolist_user_id_5209b40_fk_auth_user_id` FOREIGN KEY (`user_id`
) REFERENCES `auth_user` (` id `
)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET =utf8;
